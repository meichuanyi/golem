...
use golem_common::model::oplog::{
    ...
    HostRequestGolemRpcScheduledInvocationCancellation, HostResponseGolemRpcInvokeAndAwait,
    ...
    async fn schedule_cancelable_invocation(
        ...
        let result = if durability.is_live() {
            ...
            let result = self
                ...
                .scheduler_service
                .schedule(
                    chrono::DateTime::from_timestamp(datetime.seconds, datetime.nanoseconds)
